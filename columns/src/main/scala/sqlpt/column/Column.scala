...
object Column
  extends Arithmetic
  with AggregationFuncs
  with WindowingAndAnalytics
  with Literals
  with Misc
  with Nullables
  with Dates
...
private[column] trait Arithmetic {
...
private[column] trait AggregationFuncs {
...
private[column] trait WindowingAndAnalytics {
...
private[column] trait Nullables {
